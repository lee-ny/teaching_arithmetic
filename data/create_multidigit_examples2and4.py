...
p_list = [100, 950, 0, 950]
print('number of examples for each digit: ', p_list)
print('number of examples for each carry: ', target_num_carry_examples)
...
output_filename = f'{out_dir}/add_examples_2and4_{total_num_examples}.txt'
...
if os.path.exists(output_filename):
        ...
        for num_digit in range(1, num_digits+1):
            ...
            while num_digit_example < p_list[num_digit-1] and num_example < total_num_examples:
                ...
                if num_carry_list[num_carry] < target_num_carry_examples:
                    ...
                    continue
                if num_example > 1000:
                    print(print(num_digit, p_list[num_digit-1], num_example, num_carry_list))
    ...
    output_filename_shuffled = f'{out_dir}/add_examples_2and4_{total_num_examples}_shuffled.txt'
...
train_ids.tofile(f'{out_dir}/train_2and4_{total_num_examples}.bin')
val_ids.tofile(f'{out_dir}/val_2and4_{total_num_examples}.bin')
