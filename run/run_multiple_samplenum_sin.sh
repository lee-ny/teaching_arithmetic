...
for num_train in {1000,3000,5000,10000,20000,40000}; do
    echo $num_train
    python train.py config2/sin/train_addition_bal.py \
    --wandb_run_name="plain_${num_train}" \
    --train_data_path="train_sin_${num_train}.txt" \
    --ckpt_path_name="ckpt_${num_train}.pt"
done

python sample_addition.py \
--wandb_log=True --wandb_project='sin_sqrt' --wandb_run_name='eval_sin_plain_Zeroshot' \
--plot_sample_acc=True --select='samplenum' \
--data_type='text' --data_format='plain' --operator='sin' --num_digit=5 --max_new_tokens=8 \
--dataset='sin' --out_dir='out2/sin' \
--start="FILE:data/sin/test_sin_10000.txt" --device='cuda:0'

python sample_addition.py \
--wandb_log=True --wandb_project='sin_sqrt' --wandb_run_name='eval_sin_plain_Zeroshot_eps_5e_4' \
...
python sample_addition.py \
--wandb_log=True --wandb_project='sin_sqrt' --wandb_run_name='eval_sin_plain_Zeroshot_eps_5e_3' \
--plot_sample_acc=True --select='samplenum' --eps=5e-3 \
--data_type='text' --data_format='plain' --operator='sin' --num_digit=5 --max_new_tokens=8 \
--dataset='sin' --out_dir='out2/sin' \
--start="FILE:data/sin/test_sin_10000.txt" --device='cuda:1'


for num_train in {1000,3000,5000,10000,20000,40000}; do
    echo $num_train
    python train.py config2/sin/train_ar.py \
...
python sample_addition.py \
--wandb_log=True --wandb_project='sin_sqrt' --wandb_run_name='eval_sin_ar_Zeroshot' \
--plot_sample_acc=True --select='samplenum' \
--algo_reason=True --data_type='text' --data_format='algo_reasoning' --operator='sin' --num_digit=5 \
--dataset='sin' --out_dir='out2/sin_ar' \
--start="FILE:data/sin/test_sin_1000.txt" --device='cuda:1'

python sample_addition.py \
--wandb_log=True --wandb_project='sin_sqrt' --wandb_run_name='eval_sin_ar_Zeroshot_eps_5e_4' \
--plot_sample_acc=True --select='samplenum' --eps=5e-4 \
--algo_reason=True --data_type='text' --data_format='algo_reasoning' --operator='sin' --num_digit=5 \
--dataset='sin' --out_dir='out2/sin_ar' \
--start="FILE:data/sin/test_sin_1000.txt" --device='cuda:0'

python sample_addition.py \
--wandb_log=True --wandb_project='sin_sqrt' --wandb_run_name='eval_sin_ar_Zeroshot_eps_5e_3' \
--plot_sample_acc=True --select='samplenum' --eps=5e-3 \
--algo_reason=True --data_type='text' --data_format='algo_reasoning' --operator='sin' --num_digit=5 \
--dataset='sin' --out_dir='out2/sin_ar' \
--start="FILE:data/sin/test_sin_1000.txt" --device='cuda:1'
...
--plot_sample_acc=True --select='samplenum' --eps=5e-4 \
--algo_reason=True --data_type='text' --data_format='algo_reasoning' --operator='sin' --num_digit=5 \
--dataset='sin' --out_dir='out2/sin_ar_v2' \
--start="FILE:data/sin/test_sin_1000.txt" --device='cuda:0'
