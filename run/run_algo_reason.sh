...
### Task1
## Toy
# python train.py config/algo_reasoning/train_addition.py --wandb_log=False --n_layer=3 --n_head=3

# python train.py config/algo_reasoning/train_addition.py --wandb_run_name='lr_1e-3' --ckpt_path_name='ckpt_lr_1e-3.pt'

# python evaluate_additions.py --wandb_project='algo_reasoning' --wandb_run_name='eval_algo_reason' --device='cuda:1' \
# --out_dir='out/algo_reasoning-addition' --ckpt_path_name=ckpt_lr1e-4_final.pt \
# --algo_reason=True --dataset='algo_reasoning' \
